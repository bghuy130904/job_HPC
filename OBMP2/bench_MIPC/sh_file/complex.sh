...
#SBATCH --output=/data/giahuy/Result/OBMP2_in_DFT/Ligands_Protein/_output/complex_1.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/OBMP2_in_DFT/Ligands_Protein/_error/complex_1.err             ### Standard error file
