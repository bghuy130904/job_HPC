...
#SBATCH --output=/data/giahuy/Result/OBMP2_in_DFT/Ligands_Protein/_output/complex_2.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/OBMP2_in_DFT/Ligands_Protein/_error/complex_2.err             ### Standard error file
...
INPUT_FILE="/home/giahuy/Code/job/OBMP2/bench_MIPC/_src/complex.py"
