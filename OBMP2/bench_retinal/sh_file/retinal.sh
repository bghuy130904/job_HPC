...
#SBATCH --job-name=retinal_0 ### Job name
#SBATCH --output=/data/giahuy/Result/OBMP2_in_DFT/retinal/_output/retinal_0.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/OBMP2_in_DFT/retinal/_error/retinal_0.err             ### Standard error file
...
INPUT_FILE="/home/giahuy/Code/job/OBMP2/bench_retinal/_src/obdh.py"
# Ghi output trực tiếp ra /data
OUTPUT_DIR="/data/giahuy/Result/OBMP2_in_DFT/retinal"
mkdir -p $OUTPUT_DIR
OUTPUT_FILE="$OUTPUT_DIR/retinal_0.txt"
