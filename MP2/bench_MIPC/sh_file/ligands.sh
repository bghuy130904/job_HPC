...
#SBATCH --output=/data/giahuy/Result/MP2_in_DFT/Ligands_Protein/_output/ligands_1.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/MP2_in_DFT/Ligands_Protein/_error/ligands_1.err             ### Standard error file
