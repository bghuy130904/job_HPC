...
#SBATCH --output=/data/giahuy/Result/MP2_in_DFT/Ligands_Protein/_output/ligands_3.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/MP2_in_DFT/Ligands_Protein/_error/ligands_3.err             ### Standard error file
...
OUTPUT_DIR="/data/giahuy/Result/MP2_in_DFT/Ligands_Protein/system_3"
mkdir -p $OUTPUT_DIR
