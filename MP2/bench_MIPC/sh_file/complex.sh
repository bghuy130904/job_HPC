...
#SBATCH --output=/data/giahuy/Result/MP2_in_DFT/Ligands_Protein/_output/complex_4.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/MP2_in_DFT/Ligands_Protein/_error/complex_4.err             ### Standard error file
