...
#SBATCH --output=/data/giahuy/Result/MP2_in_DFT/Ligands_Protein/_output/complex_3.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/MP2_in_DFT/Ligands_Protein/_error/complex_3.err             ### Standard error file
