...
#SBATCH --output=/data/giahuy/Result/OBMP2/dipole_moments/_output/dipmomt_sp.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/OBMP2/dipole_moments/_error/dipmomt_sp.err             ### Standard error file
...
INPUT_FILE="/home/giahuy/Code/job/OBDH/obdh.py"
# Ghi output trực tiếp ra /data
OUTPUT_DIR="/data/giahuy/Result/OBMP2/dipole_moments/$SLURM_JOB_ID"
mkdir -p $OUTPUT_DIR
