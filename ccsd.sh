...
#SBATCH --output=/data/giahuy/Result/CCSD/dipole_moments/_output/dipmomt_sp.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/CCSD/dipole_moments/_error/dipmomt_sp.err             ### Standard error file
...
INPUT_FILE="/home/giahuy/Code/job/CCSD/_src/calc_dipmomt_ccsd.py"
# Ghi output trực tiếp ra /data
OUTPUT_DIR="/data/giahuy/Result/CCSD/dipole_moments/$SLURM_JOB_ID"
mkdir -p $OUTPUT_DIR
