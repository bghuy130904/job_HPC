...
#SBATCH --output=/data/giahuy/Result/DFT_in_DFT/B2PLYP_in_DFT/bench_MIPC/_output/ligands_3.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/DFT_in_DFT/B2PLYP_in_DFT/bench_MIPC/_error/ligands_3.err             ### Standard error file
...
mkdir -p $OUTPUT_DIR
OUTPUT_FILE="$OUTPUT_DIR/ligands_3.txt"
