...
#SBATCH --output=/data/giahuy/Result/DFT_in_DFT/B2PLYP_in_DFT/bench_MIPC/_output/cation_4.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/DFT_in_DFT/B2PLYP_in_DFT/bench_MIPC/_error/cation_4.err             ### Standard error file
