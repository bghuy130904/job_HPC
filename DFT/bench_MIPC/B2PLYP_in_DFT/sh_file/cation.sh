...
#SBATCH --output=/data/giahuy/Result/DFT_in_DFT/B2PLYP_in_DFT/bench_MIPC/_output/cation_1.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/DFT_in_DFT/B2PLYP_in_DFT/bench_MIPC/_error/cation_1.err             ### Standard error file
...
INPUT_FILE="/home/giahuy/Code/job/DFT/bench_MIPC/B2PLYP_in_DFT/_src/cation.py"
