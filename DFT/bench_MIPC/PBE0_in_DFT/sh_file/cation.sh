...
#SBATCH --output=/data/giahuy/Result/DFT_in_DFT/PBE0_in_DFT/bench_MIPC/_output/cation_2.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/DFT_in_DFT/PBE0_in_DFT/bench_MIPC/_error/cation_2.err             ### Standard error file
...
mkdir -p $OUTPUT_DIR
OUTPUT_FILE="$OUTPUT_DIR/cation_2_xcenv_obdh.txt"
