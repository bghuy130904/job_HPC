...
#SBATCH --job-name=complex_1 ### Job name
#SBATCH --output=/data/giahuy/Result/DFT_in_DFT/PBE0_in_DFT/bench_MIPC/_output/complex_1.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/DFT_in_DFT/PBE0_in_DFT/bench_MIPC/_error/complex_1.err             ### Standard error file
...
mkdir -p $OUTPUT_DIR
OUTPUT_FILE="$OUTPUT_DIR/complex_1_xcenv_obdh.txt"
