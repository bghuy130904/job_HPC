...
#SBATCH --output=/data/giahuy/Result/DFT_in_DFT/PBE0_in_DFT/bench_MIPC/_output/complex_4.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/DFT_in_DFT/PBE0_in_DFT/bench_MIPC/_error/complex_4.err             ### Standard error file
...
mkdir -p $OUTPUT_DIR
OUTPUT_FILE="$OUTPUT_DIR/complex_4_xcenv_obdh.txt"
