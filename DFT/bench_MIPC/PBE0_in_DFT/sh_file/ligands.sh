...
#SBATCH --output=/data/giahuy/Result/DFT_in_DFT/PBE0_in_DFT/bench_MIPC/_output/ligands_4.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/DFT_in_DFT/PBE0_in_DFT/bench_MIPC/_error/ligands_4.err             ### Standard error file
...
INPUT_FILE="/home/giahuy/Code/job/DFT/bench_MIPC/PBE0_in_DFT/_src/ligands.py"
# Ghi output trực tiếp ra /data
OUTPUT_DIR="/data/giahuy/Result/DFT_in_DFT/PBE0_in_DFT/bench_MIPC/system_4"
mkdir -p $OUTPUT_DIR
OUTPUT_FILE="$OUTPUT_DIR/ligands_4_xcenv_obdh.txt"
