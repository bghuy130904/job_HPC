...
#SBATCH --output=/data/giahuy/Result/OBDH_in_DFT/Ligands_Protein/_output/complex_2.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/OBDH_in_DFT/Ligands_Protein/_error/complex_2.err             ### Standard error file
...
OUTPUT_DIR="/data/giahuy/Result/OBDH_in_DFT/Ligands_Protein/system_2"
mkdir -p $OUTPUT_DIR
