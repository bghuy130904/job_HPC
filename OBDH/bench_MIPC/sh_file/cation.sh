...
#SBATCH --output=/data/giahuy/Result/OBDH_in_DFT/Ligands_Protein/_output/cation_2.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/OBDH_in_DFT/Ligands_Protein/_error/cation_2.err             ### Standard error file
