...
#SBATCH --output=/data/giahuy/Result/OBDH_in_DFT/Ligands_Protein/_output/ligands_3.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/OBDH_in_DFT/Ligands_Protein/_error/ligands_3.err             ### Standard error file
...
INPUT_FILE="/home/giahuy/Code/job/OBDH/bench_MIPC/_src/ligands.py"
# Ghi output trực tiếp ra /data
OUTPUT_DIR="/data/giahuy/Result/OBDH_in_DFT/Ligands_Protein/system_3"
mkdir -p $OUTPUT_DIR
OUTPUT_FILE="$OUTPUT_DIR/ligands_3_bigmem.txt"
