...
#SBATCH --output=/data/giahuy/Result/OBDH/dipole_moments/_output/dipmomt_sp.out          ### Standard output file
#SBATCH --error=/data/giahuy/Result/OBDH/dipole_moments/_error/dipmomt_sp.err             ### Standard error file
...
OUTPUT_DIR="/data/giahuy/Result/OBDH/dipole_moments/$SLURM_JOB_ID"
mkdir -p $OUTPUT_DIR
